...
// Available styles:
$config['styleAvailable'] = array(
// 'beige','black','grey','Oxygen','Lithium','Sulfur','Cobalt','Mercury',
'Mylib',
// 'Radium','prosilver',
'subsilver2',
/*'subblack2','subSilver','Core','MyBB','vBulletin'*/);
// Default style:
$config['styleDefault'] = 'Mylib';
...
$config['defaultChannelName'] = 'Моята библиотека';
...
$config['messageTextMaxLength'] = 2080;
...
$config['logsRequestMessagesLimit'] = 100;
