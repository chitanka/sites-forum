...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER'				=> 'BB кодът, който се опитвате да добавите изглежда несигурен. Ако BB кодът използва {TEXT} токен в такъв контекст, може да се появи проблем, използвай по рестриктивен тип. Продължете само ако разбирате риска.',
	...
	'BBCODE_INVALID_TEMPLATE'	=> 'Вашият BBCode шаблон е невалиден.',
	'BBCODE_TAG'				=> 'Таг',
	...
	'tokens'	=>	array(
		...
		'URL'			=> 'Валиден URL адрес използващ позволен протокол (http, ftp, и други... не могат да бъдат използвани за javascript експлоити). Ако не въведете протокол, ще се използва "http://" по подразбиране.',
