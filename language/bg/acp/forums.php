...
$lang = array_merge($lang, array(
	...
	'LINK'					=> 'Връзка',
	'LIMIT_SUBFORUMS'			=> 'Лимитирай легендата на директните подфоруми',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'Лимитира показването на подфоруми, показвани във подфорумите, които са директни потомци (деца) на избраният форум. Спирането на тази опция ще направи така, че всички подфоруми да се показват с опцията “Показвай подфоруми в легендата”, независимо от дълбочината.',
