...
$lang = array_merge($lang, array(
	...
	'DISPLAY_UNAPPROVED_POSTS'		=> 'Показвай неодобрените мнения на автора',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'Неодобрение мнения ще бъдат видими за автора им. Не важи за мнения от гости.',
...
$lang = array_merge($lang, array(
	...
	'APACHE_SETUP_BEFORE_USE'	=> 'Трябва да настроите Apache автентикацията преди да може да включите phpBB към този метод за автентикация. Имайте предвид, че потребителското името което използвате за Apache автентикацията, трябва да е същото като вашето phpBB потрбителско име. Apache автентикацията може да се използва само с mod_php (не може със CGI версията)',
