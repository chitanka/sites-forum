...
$lang = array_merge($lang, array(
    'TOPIC_EVALUATION_RESULT'		=> 'Обща оценка: %d.%s',
    'TOPIC_EVALUATION_RESULT_LBL'   => 'Оценка',
	'YOUR_EVALUATION1'				=> ' Оценката ви тук е положителна.',
	'YOUR_EVALUATION2'				=> ' Оценката ви тук е отрицателна.',
    'TOPIC_NOT_EVALUATED'           => 'Все още няма оценки.',
    ...
    'ACP_EVALUATION'                => 'Форумът ще се използва за Идеи',
