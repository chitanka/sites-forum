	...
	function main($id, $mode)
	{
		...
		switch ($mode)
		{
			...
			case 'profile_info':
				...
				include dirname(__FILE__) .'/ucp_profile_username_color_change.1.mod.php'; // borislav
				...
				if ($submit)
				{
					...
					include dirname(__FILE__) .'/ucp_profile_username_color_change.2.mod.php'; // borislav
					...
					include dirname(__FILE__) .'/ucp_profile_username_color_change.3.mod.php'; // borislav
					...
					if (!sizeof($error))
					{
						...
						include dirname(__FILE__) .'/ucp_profile_username_color_change.4.mod.php'; // borislav
				...
				include dirname(__FILE__) .'/ucp_profile_username_color_change.5.mod.php'; // borislav
				$template->assign_vars(array(
					'ERROR'		=> (sizeof($error)) ? implode('<br />', $error) : '',
