...
function group_set_user_default($group_id, $user_id_ary, $group_attributes = false, $update_listing = false)
{
	...
	include dirname(__FILE__) .'/functions_user_username_color_change.1.mod.php'; // borislav

	if (!empty($user_id_ary)) // borislav: the "if" clause
	{
	...
	include dirname(__FILE__) .'/functions_user_username_color_change.2.mod.php'; // borislav

	if (empty($user_colour_static) && isset($sql_ary['user_colour'])) // borislav: the "empty"
	{
