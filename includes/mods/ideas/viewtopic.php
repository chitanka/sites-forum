...
function evaluation_display()
{
    ...
    $template->assign_vars(array(
		...
		'EVALUATION_LINK_POS'		=> append_sid($phpbb_root_path . 'viewtopic.' . $phpEx, $evaluationLinkParams + array('evaluation' => '1')),
		'EVALUATION_LINK_NEG'		=> append_sid($phpbb_root_path . 'viewtopic.' . $phpEx, $evaluationLinkParams + array('evaluation' => '-1')),
	));
