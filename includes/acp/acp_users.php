		...
		switch ($mode)
		{
			case 'overview':
				...
				if ($submit)
				{
					...
					include dirname(__FILE__) .'/acp_users_username_color_change.1.mod.php'; // borislav
					...
					if (!sizeof($error))
					{
						...
						include dirname(__FILE__) .'/acp_users_username_color_change.3.mod.php'; // borislav
				...
				include dirname(__FILE__) .'/acp_users_username_color_change.4.mod.php'; // borislav
