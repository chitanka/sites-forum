...
if ($submit || $preview || $refresh)
{
	...
	{
		include_once($phpbb_root_path . 'includes/functions_user.' . $phpEx); // borislav - include_once
	...
	if (!sizeof($error) && $submit)
	{
		...
		if ($submit)
		{
			...
			{
				include_once $phpbb_root_path.'posting_new_post_to_ajaxchat.mod.php'; // borislav
